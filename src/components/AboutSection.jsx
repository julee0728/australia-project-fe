        ...
        <section id="about" className="w-full relative py-24 md:py-32 px-8 lg:px-24 overflow-hidden bg-[#f0f7ff]">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between relative z-10">
                ...
                <div className="md:w-1/2 space-y-8 pr-4 animate-fade-up opacity-0 animation-delay-200" style={{ animationFillMode: 'forwards' }}>
                    <div className="inline-block px-4 py-1.5 bg-blue-100 text-[#3174c8] rounded-full text-sm font-bold uppercase tracking-widest mb-2">
                        Professional & Trusted
                    </div>
                    <h2 className="text-[44px] lg:text-[56px] font-extrabold text-[#2e425a] leading-[1.1] tracking-tight">
                        We Are Australia's Most Trusted <span className="text-[#3174c8]">Home Service</span> Experts
                    </h2>
                    <p className="text-[20px] text-[#55677d] leading-relaxed font-medium">
                        With over 15 years of experience, we provide high-quality building and repair services across Australia. From minor leaks to major renovations, our certified professionals handle it all with precision and care.
                    </p>
                    ...
                    <ul className="space-y-4">
                        {[
                            ...
                            <li key={idx} className="flex items-center gap-3 text-lg font-semibold text-[#2e425a]">
