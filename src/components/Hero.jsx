...
const Hero = ({ onContactClick }) => {
    return (
        <section id="home" className="w-full relative pt-32 pb-44 px-8 lg:px-24 overflow-hidden border-b border-gray-200">
            {/* Background Image */}
            <div
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-start relative z-10 pt-4">
                ...
                <div className="md:w-2/3 lg:w-1/2 space-y-5 pr-4">
                    ...
                    {/* Tags/Badges */}
                    <div className="flex flex-wrap gap-2.5 pt-5 pb-3 opacity-0 animate-fade-up animation-delay-400">
                        <span className="bg-[#fd9d58] text-white px-4 py-1.5 rounded-full text-[13px] font-semibold tracking-wide shadow-sm hover:shadow-[0_8px_20px_rgba(253,157,88,0.5)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">Carpenter</span>
                        <span className="bg-[#ffcc29] text-white px-4 py-1.5 rounded-full text-[13px] font-semibold tracking-wide shadow-sm hover:shadow-[0_8px_20px_rgba(255,204,41,0.5)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">Electrician</span>
                        <span className="bg-[#3174c8] text-white px-4 py-1.5 rounded-full text-[13px] font-semibold tracking-wide shadow-sm hover:shadow-[0_8px_20px_rgba(49,116,200,0.5)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">Plumber</span>
                        <span className="bg-[#ffad69] text-white px-4 py-1.5 rounded-full text-[13px] font-semibold tracking-wide shadow-sm hover:shadow-[0_8px_20px_rgba(255,173,105,0.5)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">Painting</span>
                    </div>

                    {/* Action Buttons */}
                    <div className="flex gap-4 pt-3 opacity-0 animate-fade-up animation-delay-400">
                        <button
