...
const ServiceDetailModal = ({ isOpen, onClose, service }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            {/* Backdrop */}
            <div
                className="absolute inset-0 bg-[#1a2b3c]/80 backdrop-blur-md transition-opacity"
                onClick={onClose}
            ></div>

            {/* Modal Content */}
            <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-300">
                ...
                <div className="p-8 md:p-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <h3 className="text-2xl font-bold text-[#233549] border-l-4 border-[#3174c8] pl-4">Full Description</h3>
                            ...
                            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                                ...
                                <ul className="space-y-2">
                                    {["Expert Workmanship", "Transparent Pricing", "Fast Turnaround", "Clean & Professional"].map((item, i) => (
                                        <li key={i} className="flex items-center gap-2 text-[#2e425a] font-semibold">
                        ...
                        <div className="space-y-8">
                            <h3 className="text-2xl font-bold text-[#233549] border-l-4 border-[#3174c8] pl-4">Key Benefits</h3>
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-[#233549]">{item.t}</h5>
                            ...
                            <button
                                onClick={onClose}
                                className="w-full bg-[#3174c8] hover:bg-[#2860a8] text-white font-black py-4 rounded-2xl shadow-xl shadow-blue-500/20 transition-all uppercase tracking-widest"
                            >
                                Close Details
                            </button>
                        </div>
